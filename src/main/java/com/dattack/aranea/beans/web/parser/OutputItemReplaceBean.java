 ...
 * @since 0.1
 */
public class OutputItemReplaceBean implements OutputItemBean {
    ...
    @XmlAttribute(name = XmlTokens.REPLACEMENT, required = true)
    ...
    public String toString() {
        ...
        builder.append("OutputColumnReplaceBean[ref=").append(ref).append(", regex=").append(regex)
